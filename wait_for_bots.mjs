...
Env: BOT_WAIT_POLL_SEC, BOT_WAIT_QUIET_SEC, BOT_WAIT_MIN_SEC, BOT_WAIT_MAX_MIN,
     JCS2_BOT_WAIT_REQUIRED (or AR_BOT_WAIT_REQUIRED / BOT_WAIT_REQUIRED) — comma-separated bot keys
     JCS2_BOT_WAIT_STATE_DIR (or AR_BOT_WAIT_STATE_DIR) — per-PR anchor JSON (default: <repo>/.jcs2-bot-wait)
